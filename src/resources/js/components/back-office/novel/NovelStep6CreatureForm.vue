        ...
        >
            ...
            >
                <InfiniteScrollApiSelect
                    ...
                    :selectedItem="creaturesForm.ai_brain_id"
                    :apiUrl="buildAiBrainSearchUrl()"
                    :multiple="false"
                    placeholder="Select AI Brain"
                    :error="creaturesForm.errors.ai_brain_id"
                    class="ai-brain-select"
                />
            </div>

            <p
                v-if="creaturesForm.errors.ai_brain_id"
