...
FontAwesomeLibrary.add(faPeopleGroup);
        ...
        >
            ...
            >
                <InfiniteScrollApiSelect
                    ...
                    :selectedItem="factionsForm.ai_brain_id"
                    :apiUrl="buildAiBrainSearchUrl()"
                    :multiple="false"
                    placeholder="Select AI Brain"
                    :error="factionsForm.errors.ai_brain_id"
                    class="ai-brain-select"
                />
            </div>

            <p
                v-if="factionsForm.errors.ai_brain_id"
