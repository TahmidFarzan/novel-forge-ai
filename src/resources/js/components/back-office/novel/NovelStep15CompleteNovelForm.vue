...
FontAwesomeLibrary.add(faWandMagicSparkles);
...
function submit() {
    if (completeNovelForm.processing) {
        return;
    }
        ...
        >
            ...
            >
                <InfiniteScrollApiSelect
                    :form="completeNovelForm"
                    fieldName="ai_brain_id"
                    :selectedItem="completeNovelForm.ai_brain_id"
                    :apiUrl="buildAiBrainSearchUrl()"
                    :multiple="false"
                    placeholder="Select AI Brain"
                    :error="completeNovelForm.errors.ai_brain_id"
                    class="ai-brain-select"
                />
            </div>

            <p
                v-if="completeNovelForm.errors.ai_brain_id"
