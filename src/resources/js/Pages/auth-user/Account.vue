...
function validateForm() {
    ...
    if (accountUpdateForm.change_password) {
        if (
            !accountUpdateForm.current_password ||
            accountUpdateForm.current_password.trim() === ""
        ) {
            accountUpdateForm.setError(
                "current_password",
        ...
        if (
            !accountUpdateForm.password ||
            accountUpdateForm.password.trim() === ""
        ) {
        ...
        if (
            !accountUpdateForm.password_confirmation ||
            accountUpdateForm.password_confirmation.trim() === ""
        ) {
            accountUpdateForm.setError(
                "password_confirmation",
...
onMounted(async () => {
    ...
    window.dispatchEvent(
        new CustomEvent("set-breadcrumb", {
            detail: [{ text: "Account", active: true }],
        }),
    );
});
</script>
                ...
                <div v-if="activeTab === 'info'" class="p-6">
                    <div class="flex flex-col md:flex-row gap-6">
                        <div class="w-32 h-32">
                            ...
                            <img
                                v-else
                                :src="'/uploads/icons/auth/user.png'"
                    ...
                    >
                        <div class="grid md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input
                                    v-model="accountUpdateForm.name"
                                ...
                                <p
                                    v-if="accountUpdateForm.errors.name"
                            ...
                            <div>
                                ...
                                <p
                                    v-if="accountUpdateForm.errors.email"
                                    class="text-red-500 text-sm mt-1"
                                >
                                    {{ accountUpdateForm.errors.email }}
                                </p>
                        ...
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input
                                v-model="accountUpdateForm.change_password"
                                type="checkbox"
                        ...
                        <div
                            v-if="accountUpdateForm.change_password"
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p
                                    v-if="accountUpdateForm.errors.password"
                                    class="text-red-500 text-sm mt-1"
                                >
                                    {{ accountUpdateForm.errors.password }}
                                </p>
