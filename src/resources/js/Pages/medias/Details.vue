...
onMounted(async () => {
    ...
    window.dispatchEvent(
        new CustomEvent("set-breadcrumb", {
            detail: [
                { text: "Media", href: route("medias.index") },
            ...
            <div class="grid md:grid-cols-2 gap-4">
                ...
                >
                    ...
                    <div>
                        ...
                        >
                        {{ media?.collection_name || "Not Available" }}
                    </div>
                    ...
                    <div>
                        ...
                        >
                        {{
                            extractModelName(media?.model_type) ||
                            "Not Available"
                        }}
                    </div>
                </div>
                    ...
                    >
                        ...
                        >
                            ...
                            <span class="text-gray-800 text-right">
                                {{
                                    value ? titleFormat(value) : "Not Available"
                                }}
                            </span>
                        </div>
                    </div>
                ...
                >
                    <div>
                        <span class="font-medium text-gray-600"
                            >Original URL:</span
                        >
                        {{ media?.original_url || "Not Available" }}
                    </div>
                    ...
                    <div>
                        <span class="font-medium text-gray-600"
                            >Preview URL:</span
                        >
                        {{ media?.preview_url || "Not Available" }}
                    </div>
                    ...
                    <div>
                        <span class="font-medium text-gray-600"
                            >Order Column:</span
                        >
                        {{ media?.order_column || "Not Available" }}
                    </div>
                </div>
            </div>
                ...
                <div class="border border-gray-200 rounded-xl p-4 space-y-2">
                    ...
                    <div>
                        <span class="font-medium text-gray-600"
                            >Created By:</span
                        >
                        {{ media?.created_by?.name || "Not Available" }}
                    </div>
                </div>
            </div>
        </div>
