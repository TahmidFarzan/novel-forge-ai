...
import { canCreateAudience, canUpdateAudience, canDeleteAudience } from '@/composables/useUserPermissions'
...
const applyFilter = () => {
    ...
    intertiaJsRoute.get(route('back-office.audiences.index'), cleanParams, {
        replace: true,
        preserveScroll: true,
        preserveState: true,
...
const canCreate = () => canCreateAudience(authUser?.value)
...
const handleDelete = (audience) => {
    if (!audience || deleteProcessing.value) return
...
<template>
    ...
    <div class="w-full space-y-6">
        ...
        <div class="flex justify-between items-center">
            ...
            <a v-if="canCreate()" :href="route('back-office.audiences.create')"
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full text-sm">
                    ...
                    <tbody class="divide-y">
                        <tr v-for="(item, index) in audiences?.data" :key="item.id" class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-4 py-3 text-right">
                                <div class="flex justify-end gap-2">
                                    ...
                                    <a :href="route('back-office.audiences.details', { slug: item.slug })"
                                        class="p-2 rounded-md text-blue-600 hover:bg-blue-50 border"
                                        title="View Details">
                                        <FontAwesomeIcon icon="info" />
                                    </a>

                                    <a v-if="canUpdate(item)" :href="route('back-office.audiences.edit', { slug: item.slug })"
