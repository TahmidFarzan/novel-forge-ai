...
import NovelGeneratorForm from '@/components/novel-generator/NovelGeneratorForm.vue'
...
const applyFilter = () => {
    ...
    intertiaJsRoute.get(route('novel-generators.index'), cleanParams, {
        replace: true,
        preserveScroll: true,
        preserveState: true,
...
const clearFilters = () => {
    ...
    intertiaJsRoute.get(route('novel-generators.index'), {}, {
        replace: true,
        preserveScroll: true,
        preserveState: true,
        onFinish: () => filterForm.processing = false,
...
const handleDelete = (item) => {
    ...
    intertiaJsRoute.delete(route('novel-generators.delete', { slug: item?.slug }), {
        onFinish: () => {
            closeDeleteModal()
