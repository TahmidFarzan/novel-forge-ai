...
const pageTitle = computed(() => `Details of ${user?.name}`)
...
const handleDelete = () => {
    ...
    intertiaJsRoute.delete(route('users.delete', { slug: user?.slug }),
        {
            preserveScroll: true,
            onFinish: () => {
...
const executeStatusAction = () => {
    ...
    intertiaJsRoute.patch(
        route(isInactive ? 'users.inactive' : 'users.active', { slug: user?.slug }), {},
        {
            preserveScroll: true,
    ...
    <div class="w-full space-y-6">
        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-2">
                <a v-if="canUpdate(user)" :href="route('users.edit', { slug: user?.slug })"
