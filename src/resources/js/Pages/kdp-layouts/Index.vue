...
const { kdpLayouts } = defineProps({
    kdpLayouts: Object,
})

const paginationOnly = computed(() => {
    if (!kdpLayouts) return {}
    const { data, ...rest } = kdpLayouts
    return rest
})
...
const applyFilter = () => {
    ...
    intertiaJsRoute.get(route('kdp-layouts.index'), cleanParams, {
        replace: true,
        preserveScroll: true,
        preserveState: true,
                ...
                <table class="min-w-full text-sm">
                    ...
                    <thead class="bg-gray-50 text-gray-600 text-xs uppercase">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-left">Page Size</th>
                            <th class="px-4 py-3 text-left">Binding</th>
                    ...
                    <tbody class="divide-y">
                        <tr v-for="(item, index) in kdpLayouts?.data" :key="item.id" class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-4 py-3 text-right">
                                <div class="flex justify-end gap-2">
                                    ...
                                    <a :href="route('kdp-layouts.details', { slug: item.slug })"
                        ...
                        <tr v-if="!kdpLayouts?.data?.length">
