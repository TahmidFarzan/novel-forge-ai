...
import { canCreateLanguage, canUpdateLanguage, canDeleteLanguage } from '@/composables/useUserPermissions'
...
const applyFilter = () => {
    ...
    intertiaJsRoute.get(route('languages.index'), cleanParams, {
        replace: true,
        preserveScroll: true,
        preserveState: true,
...
const handleDelete = (language) => {
    ...
    intertiaJsRoute.delete(route('languages.delete', { slug: language?.slug }), {
        onFinish: () => {
            closeDeleteModal()
...
<template>
    ...
    <div class="w-full space-y-6">
        ...
        <div class="flex justify-between items-center">
            ...
            <a v-if="canCreate()" :href="route('languages.create')"
                        ...
                        <tr v-for="(item, index) in languages?.data" :key="item.id" class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-4 py-3 text-right">
                                <div class="flex justify-end gap-2">
                                    ...
                                    <a :href="route('languages.details', { slug: item.slug })"
                                        class="p-2 rounded-md text-blue-600 hover:bg-blue-50 border"
                                        title="View Details">
                                        <FontAwesomeIcon icon="info" />
                                    </a>

                                    <a v-if="canUpdate(item)" :href="route('languages.edit', { slug: item.slug })"
