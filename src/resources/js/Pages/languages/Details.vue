...
const pageTitle = computed(() => `Details of ${language?.name}`)
...
onMounted(async () => {
    ...
    window.dispatchEvent(
        new CustomEvent('set-breadcrumb', {
            detail: [
                { text: 'Languages', href: route('languages.index') },
    ...
    <div class="w-full space-y-6">
        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-2">
                <a v-if="canUpdate(language)" :href="route('languages.edit', { slug: language?.slug })"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                ...
                <div class="border border-gray-200 rounded-lg p-4 space-y-2">
                    <div>
                        ...
                        <div class="text-gray-700">{{ language?.brief || 'N/A' }}</div>
                    </div>
                </div>
