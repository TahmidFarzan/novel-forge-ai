...
class HuggingFaceApiService
{
    ...
    public function formatRequestInputs(string $stepName, array $inputs): array
    {
        return match ($stepName) {
            ...
            AiPromptGeneratorHelper::AI_PROMPT_NAME_STEP3_WORLD_BIBLE_GENERATOR               => $this->step3WorldBibleRequestInputsFormatter($inputs),
            ...
            AiPromptGeneratorHelper::AI_PROMPT_NAME_STEP6_CREATURES_GENERATOR                 => $this->step6CreaturesRequestInputsFormatter($inputs),
            AiPromptGeneratorHelper::AI_PROMPT_NAME_STEP7_SYSTEMS_GENERATOR                   => $this->step7SystemsRequestInputsFormatter($inputs),
            ...
            AiPromptGeneratorHelper::AI_PROMPT_NAME_STEP11_SCENE_PLANS_GENERATOR              => $this->step11ScenePlansRequestInputsFormatter($inputs),
            AiPromptGeneratorHelper::AI_PROMPT_NAME_STEP12_DIALOGUE_PLANS_GENERATOR           => $this->step12DialoguePlansRequestInputsFormatter($inputs),
            AiPromptGeneratorHelper::AI_PROMPT_NAME_STEP13_CHAPTER_PLAN_GENERATOR             => $this->step13ChapterPlanRequestInputsFormatter($inputs),
            AiPromptGeneratorHelper::AI_PROMPT_NAME_STEP14_PAGE_PLAN_GENERATOR                => $this->step14PagePlanRequestInputsFormatter($inputs),
            AiPromptGeneratorHelper::AI_PROMPT_NAME_STEP15_1_CHAPTER_SUMMARY_GENERATOR        => $this->step15_1ChapterSummaryRequestInputsFormatter($inputs),
            AiPromptGeneratorHelper::AI_PROMPT_NAME_STEP15_2_CHAPTER_CONTENT_GENERATOR        => $this->step15_2ChapterContentRequestInputsFormatter($inputs),
    ...
    {
        return match ($stepName) {
            AiPromptGeneratorHelper::AI_PROMPT_NAME_STEP1_FOUNDATION_GENERATOR                => $this->formatStep1FoundationResponse($this->extractStep1FoundationFromResponse($apiResponse)),
            AiPromptGeneratorHelper::AI_PROMPT_NAME_STEP2_CHARACTERS_GENERATOR                => $this->formatStep2CharactersResponse($this->extractStep2CharactersFromResponse($apiResponse)),
            AiPromptGeneratorHelper::AI_PROMPT_NAME_STEP3_WORLD_BIBLE_GENERATOR               => $this->formatStep3WorldBibleResponse($this->extractStep3WorldBibleFromResponse($apiResponse)),
            AiPromptGeneratorHelper::AI_PROMPT_NAME_STEP4_LOCATIONS_GENERATOR                 => $this->formatStep4LocationsResponse($this->extractStep4LocationsFromResponse($apiResponse)),
            AiPromptGeneratorHelper::AI_PROMPT_NAME_STEP5_FACTIONS_GENERATOR                  => $this->formatStep5FactionsResponse($this->extractStep5FactionsFromResponse($apiResponse)),
            AiPromptGeneratorHelper::AI_PROMPT_NAME_STEP6_CREATURES_GENERATOR                 => $this->formatStep6CreaturesResponse($this->extractStep6CreaturesFromResponse($apiResponse)),
            AiPromptGeneratorHelper::AI_PROMPT_NAME_STEP7_SYSTEMS_GENERATOR                   => $this->formatStep7SystemsResponse($this->extractStep7SystemsFromResponse($apiResponse)),
            AiPromptGeneratorHelper::AI_PROMPT_NAME_STEP8_TIMELINE_GENERATOR                  => $this->formatStep8TimelineResponse($this->extractStep8TimelineFromResponse($apiResponse)),
            AiPromptGeneratorHelper::AI_PROMPT_NAME_STEP9_STORY_STRUCTURE_GENERATOR           => $this->formatStep9StoryStructureResponse($this->extractStep9StoryStructureFromResponse($apiResponse)),
            AiPromptGeneratorHelper::AI_PROMPT_NAME_STEP10_TWISTS_AND_FORESHADOWING_GENERATOR => $this->formatStep10TwistsAndForeshadowingResponse($this->extractStep10TwistsAndForeshadowingFromResponse($apiResponse)),
            AiPromptGeneratorHelper::AI_PROMPT_NAME_STEP11_SCENE_PLANS_GENERATOR              => $this->formatStep11ScenePlansResponse($this->extractStep11ScenePlansFromResponse($apiResponse)),
            AiPromptGeneratorHelper::AI_PROMPT_NAME_STEP12_DIALOGUE_PLANS_GENERATOR           => $this->formatStep12DialoguePlansResponse($this->extractStep12DialoguePlansFromResponse($apiResponse)),
            AiPromptGeneratorHelper::AI_PROMPT_NAME_STEP13_CHAPTER_PLAN_GENERATOR             => $this->formatStep13ChapterPlanResponse($this->extractStep13ChapterPlanFromResponse($apiResponse)),
            AiPromptGeneratorHelper::AI_PROMPT_NAME_STEP14_PAGE_PLAN_GENERATOR                => $this->formatStep14PagePlanResponse($this->extractStep14PagePlanFromResponse($apiResponse)),
            AiPromptGeneratorHelper::AI_PROMPT_NAME_STEP15_1_CHAPTER_SUMMARY_GENERATOR        => $this->formatStep15_1ChapterSummaryResponse($this->extractStep15_1ChapterSummaryFromResponse($apiResponse)),
            AiPromptGeneratorHelper::AI_PROMPT_NAME_STEP15_2_CHAPTER_CONTENT_GENERATOR        => $this->formatStep15_2ChapterContentResponse($this->extractStep15_2ChapterContentFromResponse($apiResponse)),
            default                                                                           => throw new Exception("Unknown AI step name [{$stepName}]."),
        };
    }
